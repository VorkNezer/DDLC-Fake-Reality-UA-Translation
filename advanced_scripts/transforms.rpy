...
define dissolve_white = MultipleTransition([
    False,Dissolve(1),
    Solid("#fff"), Pause(1),
...
define dissolve_slow = MultipleTransition([
    Solid("#000"), Pause(1.0),
    Solid("#000"), Dissolve(4.0),
    True])
...
define glitch_scene = MultipleTransition([
    False, Pixellate(1, 5),
    "glitch_transition", Pause(0.15),
    "glitch_transition", Pause(0.15),
    "glitch_transition", Pause(0.15),
    "glitch_transition", Pixellate(1,5),
    True])

define scene_dissolve = MultipleTransition([
    False, Dissolve(1),
    True
    ])
