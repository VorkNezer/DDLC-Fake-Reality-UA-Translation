...
define -2 gui.default_font = "gui/font/comic-sans-ms.ttf"


define -2 gui.name_font = "gui/font/comic-sans-ms-bold.ttf"


define -2 gui.interface_font = "gui/font/comic-sans-ms.ttf"
...
init -2 python:
    ...
    layout.LOADING = _("Завантаження призведе до втрати прогресу.\nВи впевнені, що хочете це зробити?")
    layout.QUIT = _("Ви впевнені, що хочете вийти?")
    layout.MAIN_MENU = _("Ви впевнені, що хочете повернутися до головного меню?\nЦе призведе до втрати прогресу.")
    layout.END_REPLAY = _("Ви впевнені, що хочете зупинити повтор?")
    layout.SLOW_SKIP = _("Ви впевнені, що хочете розпочати пропуск тексту?")
