...
define config.name = "Doki Doki Fake Reality"
...
define build.name = "DokiDokiFakeReality"
...
define config.main_menu_music = audio.ghostmenu
...
define config.save_directory = "DokiDokiFakeReality"
